    ...
    <span id="close" onclick="document.getElementById('id01').style.display='none'" class="w3-button w3-display-topright">X</span>
        ...
        <div class="form1">
            <form name="miformulario" id="miformulario" method="post">
                <div class="ndiv">
                    <input type="text" name="nom" id="name1" autocomplete="off"  placeholder="Calve de pedido" required>
                ...
                <div class="buttons">                    
                    ...
                    <button class="button" type="submit" id="btEnviar" action="Gracias.php">Enviar</button>
