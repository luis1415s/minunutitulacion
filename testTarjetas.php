...
$filters = array ("email" => "test4@test.com");

$cards = $mp->get ("/v1/customers/217978111-jqjvA7BKNoIJ7D/cards");
/*echo "Tarjeta";
echo "<pre>";
print_r ($cards);*/
?>
<form id="pay" name="pay" action="testPago.php" method="POST">
	...
	<!--<li id="nameUser">
		<label for="user">Con el nombre: <?php echo $cards["response"][0]["cardholder"]["name"]; ?> </label> 
		<input type="text"  id="nuser" value="<?php echo $cards['response'][0]['cardholder']['name']; ?>" />
	</li>-->
	<li id="cvv">
